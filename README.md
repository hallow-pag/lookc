...
![三次握手.png](/master/src/fig/三次握手.png)
* 四次挥手断开连接：
...
![/master/src/fig/四次挥手.png](/master/src/fig/四次挥手.png)
...
* 非对称加密：需要公钥和私钥，公钥用来加密，私钥用来解密
  ...
  * 常用算法：RSA，ECC，DSA
#### （30） 数字证书的了解（高频）
![/master/src/fig/数字证书.jpg](/master/src/fig/数字证书.jpg)
...
![(/master/src/fig/网络协议层.png](/master/src/fig/网络协议层.png)
...
#### （9） B树和B+树的区别（重点）
![.//master/src/fig/Bptree.png](.//master/src/fig/Bptree.png)
...
![select](/master/src/fig/select.png)
...
![epoll](/master/src/fig/epoll.png)
...
![/master/src/fig/管道通信.png](/master/src/fig/管道通信.png)
